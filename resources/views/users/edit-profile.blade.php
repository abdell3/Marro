            ...
            <div class="p-6">
                ...
                <div class="mb-8">
                    <div class="flex items-center">
                        <div class="w-24 h-24 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden mr-6">
                            @if($user->avatar)
                                <img src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->prenom }} {{ $user->nom }}" class="w-full h-full object-cover">
                            @else
                        ...
                        <div>
                            ...
                            <form action="{{ route('profile.update-avatar') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                                @csrf
                                @method('PUT')
