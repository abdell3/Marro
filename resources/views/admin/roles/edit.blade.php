                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $role->name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500" {{ in_array($role->name, ['Admin', 'Moderator', 'User']) ? 'readonly' : '' }}>
                            @error('name')
