                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('communities.update', $community->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $community->name) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('description', $community->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="rules" name="rules" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('rules', $community->rules) }}</textarea>
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('communities.show', $community->slug) }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 mr-2">
                                Cancel
                            </a>
